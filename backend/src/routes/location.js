...
const INDIA_EMERGENCY_SERVICES = [
  ...
  { id: 'del-h5', name: 'GTB Hospital', type: 'hospital', lat: 28.6852, lng: 77.3108, phone: '011-22586262', city: 'Delhi', address: 'Dilshad Garden, Delhi' },
  ...
  { id: 'del-p3', name: 'New Delhi Railway Station Police', type: 'police', lat: 28.6424, lng: 77.2196, phone: '011-23747777', city: 'Delhi', address: 'Paharganj, New Delhi' },
  { id: 'del-p4', name: 'Tourist Police Help Desk - Red Fort', type: 'police', lat: 28.6562, lng: 77.2410, phone: '011-23360160', city: 'Delhi', address: 'Near Red Fort, Old Delhi' },
  ...
  { id: 'del-ph1', name: 'Apollo Pharmacy CP', type: 'pharmacy', lat: 28.6310, lng: 77.2170, phone: '011-43003000', city: 'Delhi', address: 'Connaught Place' },
  ...
  { id: 'mum-h4', name: 'Hinduja Hospital', type: 'hospital', lat: 19.0389, lng: 72.8420, phone: '022-24452222', city: 'Mumbai', address: 'Mahim, Mumbai' },
  ...
  { id: 'mum-p3', name: 'Bandra Police Station', type: 'police', lat: 19.0544, lng: 72.8379, phone: '022-26422222', city: 'Mumbai', address: 'Bandra West, Mumbai' },
  ...
  { id: 'goa-h3', name: 'Vrundavan Hospital', type: 'hospital', lat: 15.5007, lng: 73.8262, phone: '0832-2410410', city: 'Goa', address: 'Mapusa, Goa' },
  ...
  { id: 'goa-p2', name: 'Anjuna Police Station', type: 'police', lat: 15.5735, lng: 73.7410, phone: '0832-2273233', city: 'Goa', address: 'Anjuna, North Goa' },
  { id: 'goa-p3', name: 'Panjim Police Station', type: 'police', lat: 15.4989, lng: 73.8278, phone: '0832-2225816', city: 'Goa', address: 'Panjim, Goa' },
  ...
  { id: 'jai-h2', name: 'Fortis Escorts Hospital', type: 'hospital', lat: 26.8615, lng: 75.7747, phone: '0141-2547000', city: 'Jaipur', address: 'JLN Marg, Jaipur' },
  ...
  { id: 'jai-f1', name: 'Jaipur Fire Station', type: 'fire', lat: 26.9124, lng: 75.7873, phone: '101', city: 'Jaipur', address: 'Jaipur' },
  ...
  { id: 'var-h2', name: 'Heritage Hospital', type: 'hospital', lat: 25.3176, lng: 83.0050, phone: '0542-2368888', city: 'Varanasi', address: 'Lanka, Varanasi' },
  ...
  { id: 'ker-h2', name: 'KIMS Hospital Trivandrum', type: 'hospital', lat: 8.5241, lng: 76.9366, phone: '0471-2447575', city: 'Kerala', address: 'Anayara, Thiruvananthapuram' },
  { id: 'ker-h3', name: 'Amrita Hospital Kochi', type: 'hospital', lat: 10.0261, lng: 76.3125, phone: '0484-2851234', city: 'Kerala', address: 'Edappally, Kochi' },
  ...
  { id: 'agr-h2', name: 'Pushpanjali Hospital', type: 'hospital', lat: 27.2046, lng: 78.0124, phone: '0562-4050505', city: 'Agra', address: 'Delhi Gate, Agra' },
  ...
  { id: 'agr-f1', name: 'Agra Fire Station', type: 'fire', lat: 27.1867, lng: 78.0095, phone: '101', city: 'Agra', address: 'Agra' },
...
const NATIONAL_HELPLINES = [
  { id: 'nat-1', name: 'National Emergency Number', type: 'emergency', phone: '112', description: 'All emergencies - Police, Fire, Ambulance' },
  ...
  { id: 'nat-5', name: 'Tourist Helpline (24x7)', type: 'info', phone: '1363', description: 'Ministry of Tourism India helpline' },
  { id: 'nat-6', name: 'Women Helpline', type: 'emergency', phone: '1091', description: 'Women safety helpline' },
  { id: 'nat-7', name: 'Disaster Management', type: 'emergency', phone: '1078', description: 'NDMA - Natural disasters' },
...
router.post('/update', auth, (req, res) => {
  try {
    ...
    // Keep only last 500 entries per user to prevent memory bloat
    const userLocations = db.locations.filter(l => l.userId === req.user.id);
    if (userLocations.length > 500) {
      const cutoff = userLocations[userLocations.length - 500].timestamp;
      db.locations = db.locations.filter(l => l.userId !== req.user.id || l.timestamp >= cutoff);
    }

    const user = db.users.find((u) => u.id === req.user.id);
    if (user) user.lastLocation = { lat: entry.lat, lng: entry.lng, speed: entry.speed, timestamp: entry.timestamp };
...
router.get('/all-users', auth, (req, res) => {
  ...
  const users = db.users.filter((u) => u.role === 'tourist')
    .map((u) => ({ id: u.id, name: u.name, email: u.email, phone: u.phone, lastLocation: u.lastLocation, isOnline: u.isOnline }));
  res.json({ users });
});

// Dynamic nearby services — finds closest real services from the database based on user coordinates
router.get('/nearby-services', auth, (req, res) => {
  ...
  const maxDistKm = parseFloat(req.query.radius) || 50; // default 50km radius
  const typeFilter = req.query.type; // optional: 'hospital', 'police', 'fire', 'info', 'pharmacy'

  // Calculate distance for each service and filter by proximity
  ...
  // Return top 20 closest services
